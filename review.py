...
query = "陳威明"
key = "AIzaSyA0S0SIO6gzwvzuNk3gZJp0hNY-g8adweQ"

# #取得地址ID
# url = f"https://maps.googleapis.com/maps/api/place/textsearch/xml?query={query}&key={key}"
# https://maps.googleapis.com/maps/api/place/textsearch/xml?query=陳威明&key=AIzaSyA0S0SIO6gzwvzuNk3gZJp0hNY-g8adweQ

# https://places.googleapis.com/v1/places:searchText/xml?query=陳威明&key=AIzaSyA0S0SIO6gzwvzuNk3gZJp0hNY-g8adweQ

# 只有5個reviews
# url = "https://maps.googleapis.com/maps/api/place/details/json?place_id=ChIJq6q6AoquQjQRk27N2_Y8tWE&key=AIzaSyA0S0SIO6gzwvzuNk3gZJp0hNY-g8adweQ"

# https://places.googleapis.com/v1/places/ChIJq6q6AoquQjQRk27N2_Y8tWE?fields=id,displayName,reviews&key=AIzaSyA0S0SIO6gzwvzuNk3gZJp0hNY-g8adweQ
